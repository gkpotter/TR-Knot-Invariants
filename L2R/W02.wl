...
W02[x1_, y1_, x2_, y2_] :=(12 - 24 x1 - 11 x1^2 + 11 x1^3 - 24 x2 + 22 x1 x2 + 37 x1^2 x2 - 
   11 x1^3 x2 - 11 x2^2 + 37 x1 x2^2 + 22 x1^2 x2^2 - 24 x1^3 x2^2 + 
   11 x2^3 - 11 x1 x2^3 - 24 x1^2 x2^3 + 12 x1^3 x2^3 - 12 x1^2 y1 + 
   24 x1^2 x2 y1 + 24 x1^2 x2^2 y1 - 12 x1^2 x2^3 y1 - 12 x2^2 y2 + 
   24 x1 x2^2 y2 + 24 x1^2 x2^2 y2 - 12 x1^3 x2^2 y2 + 
   24 x1^2 x2^2 y1 y2)/(12 (x1 - x2)^2 (1 - 2 x1 - 2 x1^2 + x1^3 - 
     2 x1^2 y1) (1 - 2 x2 - 2 x2^2 + x2^3 - 2 x2^2 y2));
